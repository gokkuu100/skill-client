  ...
  return (
    <div>
        ...
        <div className='content font-bold text-left text-[35px] m-[10rem] '>
            ...
            <Link to="/signup"><button className='border border-box border-orange-400 mt-[3rem] p-[0.5rem] text-[25px] text-xl'><span className='text-[#EA501A]'>JOIN</span> <span className=''>US</span></button></Link>
        </div>
    </div>
  )
}
