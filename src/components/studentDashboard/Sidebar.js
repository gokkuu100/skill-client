  ...
  return (
    <div className='flex h-screen text-white'>
        <div className="w-64 bg-gray-800 flex-none hidden md:block">
            ...
            <li className='py-4 pl-9 pr-4 hover:bg-gray-600'><Link to="/profile" onClick={() => handleLinkClick('profile')}><FontAwesomeIcon icon={faUser} /> PROFILE</Link></li>
          <li className='py-4 pl-9 pr-4 hover:bg-gray-600'><Link to='/assessment' onClick={() => handleLinkClick('assessment')}>ASSESSMENTS</Link></li>
